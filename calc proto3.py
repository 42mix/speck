...
button_0= Button(root, text="0", padx=40, pady=20, command=lambda: button_click(0)).grid(row=5, column=1)

button_add= Button(root,text="+",padx=39, pady=20, command=button_add).grid(row=5, column=3)
button_equal= Button(root,text="=",padx=93, pady=20,command=button_equal).grid(row=5, column=2,columnspan=1)
button_clear= Button(root,text="CLEAR",padx=79, pady=20, command=button_clear).grid(row=5, column=0, columnspan=1)

button_sub= Button(root,text="-",padx=41, pady=20, command=button_sub).grid(row=4, column=3)
button_multiply= Button(root,text="x",padx=42, pady=20, command=button_multiply).grid(row=3, column=3)
button_div= Button(root,text="/",padx=45, pady=20, command=button_div).grid(row=2, column=3)

button_pwr= Button(root,text="x^y",padx=41, pady=20, command=button_pwr).grid(row=1, column=2)
button_root= Button(root,text="x√",padx=42, pady=20, command=button_root).grid(row=1, column=1)
button_mod= Button(root,text="%",padx=45, pady=20, command=button_mod).grid(row=1, column=0)
button_quotient= Button(root,text="//",padx=45, pady=20, command=button_quo).grid(row=1, column=3)
