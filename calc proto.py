...
button_equal= Button(root,text="=",padx=93, pady=20,command=button_equal).grid(row=5, column=1,columnspan=2)
button_clear= Button(root,text="CLEAR",padx=79, pady=20, command=button_clear).grid(row=4, column=1, columnspan=2)

button_sub= Button(root,text="-",padx=41, pady=20, command=button_sub).grid(row=6, column=0)
button_multiply= Button(root,text="x",padx=42, pady=20, command=button_multiply).grid(row=6, column=1)
button_div= Button(root,text="/",padx=45, pady=20, command=button_div).grid(row=6, column=2)

button_pwr= Button(root,text="x^y",padx=41, pady=20, command=button_pwr).grid(row=7, column=0)
button_root= Button(root,text="x√",padx=42, pady=20, command=button_root).grid(row=7, column=1)
button_mod= Button(root,text="%",padx=45, pady=20, command=button_mod).grid(row=7, column=2)
